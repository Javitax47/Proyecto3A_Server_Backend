...
\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer}{}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer}\index{Porting to the Buffer.from/Buffer.alloc API@{Porting to the Buffer.from/Buffer.alloc API}}
\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1834}%
\Hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1834}%


\label{_overview}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1835}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1835}
...
\end{DoxyItemize}\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1836}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1836}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1837}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.\+js 8}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1837}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1838}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1838}
...
\label{_variant-1}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1839}{}\doxysection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1839}
...
\label{_variant-2}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1840}{}\doxysection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2\+: Use a polyfill}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1840}
...
\label{_variant-3}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1841}{}\doxysection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1841}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1842}{}\doxysubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1842}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1843}{}\doxysubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(not\+Number)}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1843}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1844}{}\doxysubsection{\texorpdfstring{Buffer(number)}{Buffer(number)}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1844}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1845}{}\doxysection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.\+alloc\+Unsafe}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1845}
...
\label{_faq}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1846}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1846}
\label{_design-flaws}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1847}{}\doxysubsection{\texorpdfstring{What is wrong with the {\ttfamily Buffer} constructor?}{What is wrong with the {\ttfamily Buffer} constructor?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1847}
...
\label{_ecosystem-usage}%
 \hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1848}{}\doxysubsection{\texorpdfstring{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md1848}
