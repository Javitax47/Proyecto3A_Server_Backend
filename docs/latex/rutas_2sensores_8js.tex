...
\mbox{\hyperlink{servicios_2alertas_8js_a7f43c2fdec3f5b2b2d8dc821db72c367}{router}} \mbox{\hyperlink{rutas_2sensores_8js_a696641fbb2c8fa174b13d0ff95576d75}{get}} (\textquotesingle{}/mediciones/\+:fecha\textquotesingle{}, async(req, res)=$>$ \{ \mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} \{ fecha \}=req.\+params;try \{ \mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} result=await \mbox{\hyperlink{servicios_2mediciones_8js_adf41fd97344cbf81977308ae9afbb527}{get\+Mediciones}}(fecha);res.\+status(200).send(result);\} catch(err) \{ console.\+error(err);res.\+status(500).send(\{ error\+:err.\+message \});\} \})
\begin{DoxyCompactList}\small\item\em Obtiene las mediciones realizadas en una fecha específica. \end{DoxyCompactList}\item 
\mbox{\hyperlink{servicios_2alertas_8js_a7f43c2fdec3f5b2b2d8dc821db72c367}{router}} \mbox{\hyperlink{rutas_2sensores_8js_a16979b53c1737b8ab48cd6fc2eac19d6}{post}} (\textquotesingle{}/\textquotesingle{}, async(req, res)=$>$ \{ \mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} \{ uuid, email \}=req.\+body;try \{ \mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} result=await \mbox{\hyperlink{servicios_2sensores_8js_a2153e582b5069ff975abb47d088c1323}{create\+Sensor}}(uuid, email);res.\+status(200).send(result);\} catch(err) \{ console.\+error(err);res.\+status(500).send(\{ error\+:err.\+message \});\} \})
\begin{DoxyCompactList}\small\item\em Crea un nuevo sensor en la base de datos. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} \mbox{\hyperlink{rutas_2sensores_8js_a81e570c198204c57e1ebcace4f4e6dad}{express}} = require(\textquotesingle{}express\textquotesingle{})
\item 
\mbox{\hyperlink{rutas_2sensores_8js_a92b303b76a3f942ea819498907d5e83c}{const}} \{ \mbox{\hyperlink{servicios_2mediciones_8js_a4aa3785da9c166b2a7b3860189123710}{medicion}}, \mbox{\hyperlink{servicios_2mediciones_8js_a8eca8e00491ab76e5d1df02cf8dfb08f}{latest}}, \mbox{\hyperlink{servicios_2mediciones_8js_adf41fd97344cbf81977308ae9afbb527}{get\+Mediciones}} \} = require(\textquotesingle{}../servicios/mediciones\textquotesingle{})
\item 
\mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} \mbox{\hyperlink{rutas_2sensores_8js_a7f43c2fdec3f5b2b2d8dc821db72c367}{router}} = express.\+Router()
\item 
module \mbox{\hyperlink{rutas_2sensores_8js_aa4072ba4b6b56b0fb6f4801f17ab2b34}{exports}} = \mbox{\hyperlink{servicios_2alertas_8js_a7f43c2fdec3f5b2b2d8dc821db72c367}{router}}
...
\Hypertarget{rutas_2sensores_8js_a3695bf2559fcc5813c47fec9b86259c9}\index{sensores.js@{sensores.js}!get@{get}}
\index{get@{get}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{get()}{get()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a3695bf2559fcc5813c47fec9b86259c9} 
...
\hline
\end{DoxyExceptions}
\Hypertarget{rutas_2sensores_8js_a696641fbb2c8fa174b13d0ff95576d75}\index{sensores.js@{sensores.js}!get@{get}}
\index{get@{get}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{get()}{get()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a696641fbb2c8fa174b13d0ff95576d75} 
...
\hline
\end{DoxyExceptions}
\Hypertarget{rutas_2sensores_8js_a16979b53c1737b8ab48cd6fc2eac19d6}\index{sensores.js@{sensores.js}!post@{post}}
\index{post@{post}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{post()}{post()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a16979b53c1737b8ab48cd6fc2eac19d6} 
...
\hline
\end{DoxyExceptions}
\Hypertarget{rutas_2sensores_8js_a65d03e46921fbf84f91b88ffe7a60718}\index{sensores.js@{sensores.js}!post@{post}}
\index{post@{post}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{post()}{post()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a65d03e46921fbf84f91b88ffe7a60718} 
...
\Hypertarget{rutas_2sensores_8js_a92b303b76a3f942ea819498907d5e83c}\index{sensores.js@{sensores.js}!const@{const}}
\index{const@{const}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{const}{const}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a92b303b76a3f942ea819498907d5e83c} 
...
\Hypertarget{rutas_2sensores_8js_aa4072ba4b6b56b0fb6f4801f17ab2b34}\index{sensores.js@{sensores.js}!exports@{exports}}
\index{exports@{exports}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{exports}{exports}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_aa4072ba4b6b56b0fb6f4801f17ab2b34} 
...
\Hypertarget{rutas_2sensores_8js_a81e570c198204c57e1ebcace4f4e6dad}\index{sensores.js@{sensores.js}!express@{express}}
\index{express@{express}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{express}{express}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a81e570c198204c57e1ebcace4f4e6dad} 
\mbox{\hyperlink{db_8js_a92b303b76a3f942ea819498907d5e83c}{const}} express = require(\textquotesingle{}express\textquotesingle{})}

\Hypertarget{rutas_2sensores_8js_a7f43c2fdec3f5b2b2d8dc821db72c367}\index{sensores.js@{sensores.js}!router@{router}}
\index{router@{router}!sensores.js@{sensores.js}}
\doxysubsubsection{\texorpdfstring{router}{router}}
{\footnotesize\ttfamily \label{rutas_2sensores_8js_a7f43c2fdec3f5b2b2d8dc821db72c367} 
