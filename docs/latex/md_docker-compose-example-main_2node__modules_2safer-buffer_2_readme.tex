...
\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme}{}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme}\index{safer-\/buffer $<$a href="{}https://travis-\/ci.org/ChALkeR/safer-\/buffer"{} $>$$<$img src="{}https://travis-\/ci.org/ChALkeR/safer-\/buffer.svg?branch=master"{} alt="{}travis"{}/$>$$<$/a$>$ $<$a href="{}https://npmjs.org/package/safer-\/buffer"{} $>$$<$img src="{}https://img.shields.io/npm/v/safer-\/buffer.svg"{} alt="{}npm"{}/$>$$<$/a$>$ $<$a href="{}https://standardjs.com"{} $>$$<$img src="{}https://img.shields.io/badge/code\_style-\/standard-\/brightgreen.svg"{} alt="{}javascript style guide"{}/$>$$<$/a$>$ $<$a href="{}https://github.com/nodejs/security-\/wg/blob/master/processes/responsible\_disclosure\_template.md"{} $>$$<$img src="{}https://img.shields.io/badge/Security-\/Responsible\%20Disclosure-\/green.svg"{} alt="{}Security Responsible Disclosure"{}/$>$$<$/a$>$@{safer-\/buffer $<$a href=""https://travis-\/ci.org/ChALkeR/safer-\/buffer"" $>$$<$img src=""https://travis-\/ci.org/ChALkeR/safer-\/buffer.svg?branch=master"" alt=""travis""/$>$$<$/a$>$ $<$a href=""https://npmjs.org/package/safer-\/buffer"" $>$$<$img src=""https://img.shields.io/npm/v/safer-\/buffer.svg"" alt=""npm""/$>$$<$/a$>$ $<$a href=""https://standardjs.com"" $>$$<$img src=""https://img.shields.io/badge/code\_style-\/standard-\/brightgreen.svg"" alt=""javascript style guide""/$>$$<$/a$>$ $<$a href=""https://github.com/nodejs/security-\/wg/blob/master/processes/responsible\_disclosure\_template.md"" $>$$<$img src=""https://img.shields.io/badge/Security-\/Responsible\%20Disclosure-\/green.svg"" alt=""Security Responsible Disclosure""/$>$$<$/a$>$}}
\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1849}%
\Hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1849}%


Modern Buffer API polyfill without footguns, working on Node.\+js from 0.\+8 to current.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1850}{}\doxysection{\texorpdfstring{How to use?}{How to use?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1850}
...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1851}{}\doxysection{\texorpdfstring{Do I need it?}{Do I need it?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1851}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1852}{}\doxysection{\texorpdfstring{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1852}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1853}{}\doxysection{\texorpdfstring{But isn\textquotesingle{}t throwing bad?}{But isn\textquotesingle{}t throwing bad?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1853}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1854}{}\doxysubsection{\texorpdfstring{Would it affect third-\/party modules?}{Would it affect third-\/party modules?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1854}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1855}{}\doxysubsection{\texorpdfstring{But I don\textquotesingle{}t want throwing…}{But I don\textquotesingle{}t want throwing…}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1855}
That is also fine!
...
Note that using a linter to catch accidential {\ttfamily Buffer} constructor usage in this case is strongly recommended. {\ttfamily Buffer} is not overriden in this usecase, so linters won\textquotesingle{}t get confused.\hypertarget{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1856}{}\doxysection{\texorpdfstring{«\+Without footguns»?}{«\+Without footguns»?}}\label{md_docker-compose-example-main_2node__modules_2safer-buffer_2_readme_autotoc_md1856}
