\chapter{depd}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme}{}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme}\index{depd@{depd}}
\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md449}%
\Hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md449}%
...
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md450}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md450}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md451}{}\doxysection{\texorpdfstring{API}{API}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md451}
...
{\bfseries{NOTE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md452}{}\doxysubsection{\texorpdfstring{depd(namespace)}{depd(namespace)}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md452}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md453}{}\doxysubsection{\texorpdfstring{deprecate(message)}{deprecate(message)}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md453}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md454}{}\doxysubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.\+function(fn, message)}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md454}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md455}{}\doxysubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.\+property(obj, prop, message)}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md455}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md456}{}\doxysubsection{\texorpdfstring{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md456}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md457}{}\doxysubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.\+env.\+NO\+\_\+\+DEPRECATION}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md457}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md458}{}\doxysubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.\+env.\+TRACE\+\_\+\+DEPRECATION}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md458}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md459}{}\doxysection{\texorpdfstring{Display}{Display}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md459}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md460}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md460}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md461}{}\doxysubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md461}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md462}{}\doxysubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md462}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md463}{}\doxysubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md463}
...
\end{DoxyCode}
\hypertarget{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md464}{}\doxysection{\texorpdfstring{License}{License}}\label{md_docker-compose-example-main_2node__modules_2depd_2_readme_autotoc_md464}
